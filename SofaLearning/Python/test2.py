...
def createScene(rootNode):
    ...
    # Applies default gravity force and the timestep
    rootNode.gravity = [0.0, -9.81, 0.0]
    rootNode.dt = 0.01

    # Applies mechanical model so that all future elements will have the same mass, volume, and inertia matrix.
    totalMass = 1.0
    volume = 1.0
    ...
    rootNode.addObject('RuleBasedContactManager', responseParams="mu=0.0", name='Response', response='FrictionContactConstraint')
